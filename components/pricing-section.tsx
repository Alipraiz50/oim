    ...
    >
      <div className="max-w-4xl mx-auto mb-16">
        ...
        <div className="w-full">
          <Card
            className="shadow-lg border-0 overflow-hidden w-full mx-auto"
            style={{
          ...
          >
            <CardContent className="px-4 py-6 sm:px-8 sm:py-10">
              <div className="flex bg-gray-100 rounded-lg p-2 mb-8 gap-3 sm:p-3 sm:mb-10 sm:gap-6 justify-center">
                {Object.entries(plans).map(([key, plan]) => (
                  <button
                    key={key}
                    onClick={() => setSelectedPlan(key as keyof typeof plans)}
                    className={`flex-1 py-2 px-3 sm:py-3 sm:px-6 text-sm font-medium rounded-md transition-all duration-200 ${
              ...
              <Button
                className="w-full bg-teal-600 hover:bg-teal-700 text-white font-medium py-4 rounded-lg transition-colors duration-200"
                style={{ fontFamily: "Poppins, sans-serif" }}
                size="lg"
              >
                Get Started Today
